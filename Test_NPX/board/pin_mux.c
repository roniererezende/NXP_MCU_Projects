...
- {pin_num: '57', pin_signal: PTD0/SPI0_PCS0/TPM0_CH0/FXIO0_D0, label: BLUE_LED, identifier: LED;LED_ONE;LED_BLUE;BLUE_LED}
- {pin_num: '58', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/TPM0_CH1/FXIO0_D1, label: KEY, identifier: KEY}
- {pin_num: '59', pin_signal: PTD2/SPI0_MOSI/UART2_RX/TPM0_CH2/SPI0_MISO/FXIO0_D2, label: RED_LED, identifier: LED_TWO;LED_RED;RED_LED}
- {pin_num: '60', pin_signal: PTD3/SPI0_MISO/UART2_TX/TPM0_CH3/SPI0_MOSI/FXIO0_D3, label: WHITE_LED, identifier: WRITE_LED;WHITE_LED}
- {pin_num: '61', pin_signal: PTD4/LLWU_P14/SPI1_PCS0/UART2_RX/TPM0_CH4/FXIO0_D4, label: GREEN_LED, identifier: SDA_LED;GREEN_LED}
...
- pin_list:
  - {pin_num: '58', peripheral: GPIOD, signal: 'GPIO, 1', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/TPM0_CH1/FXIO0_D1, direction: INPUT, pull_enable: enable}
  - {pin_num: '57', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: PTD0/SPI0_PCS0/TPM0_CH0/FXIO0_D0, identifier: BLUE_LED, direction: OUTPUT}
  - {pin_num: '59', peripheral: GPIOD, signal: 'GPIO, 2', pin_signal: PTD2/SPI0_MOSI/UART2_RX/TPM0_CH2/SPI0_MISO/FXIO0_D2, identifier: RED_LED, direction: OUTPUT}
  - {pin_num: '60', peripheral: GPIOD, signal: 'GPIO, 3', pin_signal: PTD3/SPI0_MISO/UART2_TX/TPM0_CH3/SPI0_MOSI/FXIO0_D3, identifier: WHITE_LED, direction: OUTPUT,
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_KEY_GPIO, BOARD_KEY_PIN, &KEY_config);
    ...
    GPIO_PinInit(BOARD_WHITE_LED_GPIO, BOARD_WHITE_LED_PIN, &WHITE_LED_config);
    ...
    PORT_SetPinMux(BOARD_KEY_PORT, BOARD_KEY_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_WHITE_LED_PORT, BOARD_WHITE_LED_PIN, kPORT_MuxAsGpio);
